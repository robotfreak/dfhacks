...
// Camera Slider command Handler 
void processCameraSliderCmd()
{
  int aNumber;
  char *arg;
...
void loop()
{
  ...
  switch(Command)
  {
    case cmdCAMERASLIDER:   // received timelapse command
      cnt = repeatCount;
      mode = modRUNNING;
      Command = cmdNONE;
